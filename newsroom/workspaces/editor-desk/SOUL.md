...
**PASS (신뢰도 90+) — ⚡ 패스트트랙 (copy-editor 단계 건너뜀):**
헤드라인 확인만 하고 **즉시 `07-copy-edited/`로 직접 이동**
→ 교열 단계 생략 (신뢰도 90+는 품질 보장됨, 속도 최우선)
→ stage 필드를 "copy-edited"로 업데이트 후 `07-copy-edited/`에 저장

**PASS (신뢰도 80-89) — 간략 검토:**
6개 체크리스트 검토:
1. 뉴스 가치 (시의성, 관련성, 중요성)
