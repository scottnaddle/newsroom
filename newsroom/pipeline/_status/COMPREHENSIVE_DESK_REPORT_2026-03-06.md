...
| 단계 | 기사 수 | 상태 | 비고 |
|------|--------|------|------|
| **01-sourced** | 3개 | ✅ 정상 | 수집 대기 |
| **02-assigned** | 0개 | ✅ 정상 | 기자 배정 완료 |
| **03-reported** | 0개 | ⏳ | 취재 진행 중 |
| **04-drafted** | 0개 | ⏳ | 기사 작성/수정 중 |
| **05-fact-checked** | 0개 | ✅ | 팩트체크 대기 |
| **06-desk-approved** | 0개 | ✅ | **현재 승인 대기 없음** |
| **07-copy-edited** | 0개 | ⏳ | 교열 진행 중 |
| **08-published** | 13개 | ✅ | **발행 완료** |
| **rejected** | 22개 | 🚫 | 거부됨 |
