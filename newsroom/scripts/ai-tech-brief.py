...
[필수 형식 - 절대 변형 금지]
1. 오프닝: "## 개요" 섹션 — 오늘의 키워드를 bullet point 3~4개로 요약
2. 각 핫이슈: "## N. 제목" 형태
   - 반드시 **키포인트:** 로 시작하는 볼드 문장 포함 (무슨 일인지, 왜 중요한지)
   - 2~3문장 요약 추가
3. 마무리: "## 핵심 인사이트" 섹션 — bullet point 3~4개로 종합 요약
4. 모든 텍스트는 반드시 한국어로만 작성 (영문 금지)
...
- 키포인트 누락
- 핵심 인사이트 섹션 누락
- 📎 [원문: ...] 형식 — 반드시 [원문: 출처명](URL) 하이퍼링크 형식 사용"""
